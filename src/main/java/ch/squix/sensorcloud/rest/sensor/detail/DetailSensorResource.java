package ch.squix.sensorcloud.rest.sensor.detail;
...
public class DetailSensorResource extends ServerResource {

	private static final Logger logger = Logger.getLogger(DetailSensorResource.class.getName());
	...
	public DataPointOutDto execute() {
		...
		return SensorDataConverter.convertToDetailDto(dataPoint);
	}
